const { sendVulnerabilities, setTracer, VULNERABILITIES_KEY } = require('./vulnerability-reporter')
...
function onIncomingHttpRequestEnd (data) {
  if (data && data.req) {
    ...
    if (iastContext && iastContext.rootSpan && iastContext[VULNERABILITIES_KEY]) {
      sendVulnerabilities(iastContext[VULNERABILITIES_KEY], iastContext.rootSpan)
